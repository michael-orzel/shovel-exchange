  ...
  return (
    <Tabs defaultActiveKey="buy" className="bg-dark text-white">
      ...
      <form onSubmit={(event) => {
          ...
          makeBuyOrder(web3, account, token, exchange, buyOrder, dispatch)
        }}>
          <div className="form-group-msall">
            <label>Buy Amount (SHVL)</label>
      ...
      <form onSubmit={(event) => {
          event.preventDefault()
          makeSellOrder(web3, account, token, exchange, sellOrder, dispatch)
        }}>
          <div className="form-group-msall">
            <label>Sell Amount (SHVL)</label>
            <div className="input-group">
              <input 
                type="text"
                placeholder="Buy Amount"
